	...
	return {
		...
		[Mod.Card.MERGED_CARD.ID] = {
			...
			Description = {
				...
				"#{{Card" ..
				Card.CARD_EMPRESS .. "}} {{Collectible" .. CollectibleType.COLLECTIBLE_THE_NAIL .. "}} The Nail",
				...
				"#{{Card" ..
				Card.CARD_HERMIT .. "}} {{Collectible" .. CollectibleType.COLLECTIBLE_KEEPERS_BOX .. "}} Keeper's Box",
