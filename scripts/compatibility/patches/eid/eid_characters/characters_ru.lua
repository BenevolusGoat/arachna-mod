	...
	return {
		[Mod.PlayerType.ARACHNA] = {
			...
			Description = {
				...
				"#Пауки из Паучьих Коконов могут быть {{ColorRainbow}}особыми{{CR}} и иметь уникальные эффекты",
			}
		},
		[Mod.PlayerType.ARACHNA_B] = {
			...
			Description = {
				...
				"#↓ Паучьи Коконы меньшего размера",
				"#{{StatusSpiderBite}} Коконы могут быть {{ColorRainbow}}особыми{{CR}}, создавая особых пауков",
			}
		},
	}
end
