...
WOP:AddOutcomeFloat(ARACHNOLOGY_101.RewardType.SPIDER_FACT, 0.7)
WOP:AddOutcomeFloat(ARACHNOLOGY_101.RewardType.WEB_HEART, 0.15)
WOP:AddOutcomeFloat(ARACHNOLOGY_101.RewardType.BLUE_SPIDERS, 0.15)
...
function ARACHNOLOGY_101:OnUse(item, rng, player)
	...
	if reward == ARACHNOLOGY_101.RewardType.SPIDER_FACT then
	...
	elseif reward == ARACHNOLOGY_101.RewardType.WEB_HEART then
	...
	elseif reward == ARACHNOLOGY_101.RewardType.BLUE_SPIDERS then
