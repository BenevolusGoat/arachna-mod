...
local arachnaDssDirectory = {
	...
	credits = {
		...
		buttons = {
			...
			BREAK_LINE,
			BREAK_LINE,
			{str = "translators", fsize = 3, tooltip = GenerateTooltip("created translations for external item descriptions")},
			{str = "oucalgarlin", fsize = 2, tooltip = GenerateTooltip("chinese translations")},
			BREAK_LINE,
			BREAK_LINE,
