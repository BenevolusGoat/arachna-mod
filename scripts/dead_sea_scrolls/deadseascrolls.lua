...
local arachnaDssDirectory = {
	...
	credits = {
		...
		buttons = {
			...
			{str = "rvsty", fsize = 2, tooltip = GenerateTooltip("v1.0 russian translations. v2.0 ukrainian translations")},
	...
	rgonpopup = {
		...
		buttons = GenerateNoSelDescription(
            ...
            BREAK_LINE,
			"this 2.0 version of the arachna mod requires repentogon on repentance+ to function!",
			BREAK_LINE,
			...
			BREAK_LINE,
			"if you wish to downgrade, please check the workshop description for the legacy version instead",
			BREAK_LINE,
			{
				str = "i understand",
				action = "resume",
